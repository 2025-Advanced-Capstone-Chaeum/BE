...
(5, '어르신 이동을 위한 휠체어 지원', '제가 다리가 아파서 혼자 외출이 어렵더라구요. 휠체어가 있으면 정말 편할 거 같습니다.',
...
(6, '다문화가정 식탁 지원', '저희가 인원이 많은데 식탁이 너무 작더라구요. 함께 앉아 식사할 수 있는 추가적인 식탁이 필요해요.',
